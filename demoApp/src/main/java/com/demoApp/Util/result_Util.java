...
public class result_Util extends Model{
	...
	public static String addResult(int location, String sales, String company, String acct, String date ) throws SQLException {
		db_Util.openTransaction();
		Demoresult fineUser = new Demoresult();
		boolean status = fineUser.set("LocCode", location, "STCode", sales, "CostCompCode", company, "AcCode", acct, "date", date).insert();
